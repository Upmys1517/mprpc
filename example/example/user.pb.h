...
class ResultCode PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_example_2fuser_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline std::string* RegisterRequest::unsafe_arena_release_username() {
  // @@protoc_insertion_point(field_unsafe_arena_release:fixbug.RegisterRequest.username)
  GOOGLE_DCHECK(GetArena() != nullptr);
...
inline void RegisterRequest::unsafe_arena_set_allocated_username(
  ...
  username_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      username, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.RegisterRequest.username)
}
