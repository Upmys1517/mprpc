...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_src_2frpcheader_2eproto = {
  false, false, descriptor_table_protodef_src_2frpcheader_2eproto, "src/rpcheader.proto", 111,
...
static bool dynamic_init_dummy_src_2frpcheader_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_src_2frpcheader_2eproto)), true);
namespace mprpc {
